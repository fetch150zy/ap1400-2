...
/** It is not recommended to write this. There are too many forms 
*   of upper triangular transformation (the solution is not unique), 
*   and it does not make much sense to only satisfy this special case. 
*   The test here is too simple and lacks rationality. 
*/
// TEST(HW1Test, BONUS) {
//     // test case
